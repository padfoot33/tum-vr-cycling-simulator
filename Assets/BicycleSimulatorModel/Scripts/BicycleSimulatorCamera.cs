...
{
    public class BicycleSimulatorCamera : MonoBehaviour
    {
        ...
        PerfectMouseLookSimulator perfectMouseLook;



        void Start()
        {
            perfectMouseLook = GetComponent<PerfectMouseLookSimulator>();
            if (stuntCamera)
            {
                var follow = new GameObject("Follow");
                var toFollow = GameObject.FindObjectOfType<BicycleSimulatorController>().transform;
                ...
                target = GameObject.FindObjectOfType<BicycleSimulatorController>().transform;
        }
