...
{
    public class RagdollJointConfigSimulator : MonoBehaviour
    {
        ...
        RagdollJointImitationSimulator ragdollJointImitation;
        bool onAnimatorIK;

        void Start()
        {
            ragdollJointImitation = FindObjectOfType<RagdollJointImitationSimulator>();
            maxForce = 2000f;
