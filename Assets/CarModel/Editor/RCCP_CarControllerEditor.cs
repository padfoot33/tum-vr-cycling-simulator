...
"ReceiveOutput", new Type[] { typeof(RCCP_Output) });
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("isSumoVehcile"), new GUIContent("SumoVehcile", "Disable this if you want to run the vehicle manually!"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("kp_control"), new GUIContent("kp_control", "test"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("ki_control"), new GUIContent("ki_control", "test"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("kd_control"), new GUIContent("kd_control", "test"));
